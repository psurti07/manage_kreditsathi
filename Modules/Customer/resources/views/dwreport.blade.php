                                                                        ...
                                                                        <td class="es-m-p20b" align="left"
                                                                            ...
                                                                            <table cellpadding="0" cellspacing="0"
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td
                                                                                            style="padding:0  20px; margin: 0; line-height: 1.5rem;background-color: #E9F2FB; color:#000;font-size:16px; border-radius: 12px;font-family: Poppins, sans-serif;">
                                                                    ...
                                                                    <tr>
                                                                        <td class="es-m-p20b" align="left"
                                                                            ...
                                                                            <table width="100%" bgcolor="#ffffff" style="border-radius: 15px; background-color: transparent;margin-bottom:15px;">
                                                                                <tr>
                                                                                    <td style="padding: 0 20px; background-color: #E9F2FB; color: #000; font-size: 16px; border-radius: 12px;font-family: Poppins, sans-serif;">
                                                                                        <table width="100%" style="width: 100%;">
                                                                                            ...
                                                                                            <tr>
                                                                                                <td><h5 style="margin:0">{{ $agent->fullname ?? 'N/A' }}</h5></td>
                                                                                                <td><h5 style="margin:0">{{ isset($agent) ? '+91'.$agent->mobile : 'N/A' }}</h5></td>
                                                                                                <td><h5 style="margin:0">{{ $agent->emailid ?? 'N/A' }}</h5></td>
                                                                                            </tr>
                                                                                        </table>
                                                                                    </td>
                                                                                </tr>
                                                                            ...
                                                                            <table class="offers-table">
                                                                                ...
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr style="font-family: Poppins, sans-serif;">
                                                                                        ...
                                                                                        <td><img src="{{ asset('upload/banks/'.$offer->bank_image) }}" alt="{{ $offer->bank_name }}" class="bank-logo"></td>
                                                                                    ...
                                                                                    @php
                                                                                        switch($remark->service){
                                                                                            case 5:
                                                                                                ...
                                                                                                break;
                                                                                            case 6:
                                                                                                $service = $userData->acc_type == 1 ? 'Service Closed' : 'Service Call 1';
                                                                                                break;
                                                                                            case 7:
