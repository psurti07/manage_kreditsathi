    ...
    <body>
        <div class="es-wrapper-color" style="background-color: #f9f9f9;">
            <table class="es-wrapper" width="100%" cellspacing="0" cellpadding="0" style="
                ...
                background-image: url(https://kreditsathi.com/assets/images/mail-bgm.png);
                background-color: #f9f9f9;
                " background="https://kreditsathi.com/front/images/bg-01.webp">
                <tbody>
                    <tr>
                                                                        ...
                                                                        <td class="es-m-p20b" align="left"
                                                                            ...
                                                                            <table cellpadding="0" cellspacing="0"
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td align="center"
                                                                                            style="padding: 20px; margin: 0; line-height: 2rem;    background-color: #fffcf0;border-top-right-radius:12px;border-top-left-radius:12px;">
                                                                                            <p
                                                                                                style="font-size:2.2rem;color:#0055da;font-weight:600">
                                                                                                Congratulations ! 
                                                                                            </p>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td align="left"
                                                                                            ...
                                                                                            <p><strong>
                                                                                                🎉 Thank You for choosing kreditsathi!
                                                                                                </strong>
                                                                                            </p>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td align="left"
                                                            ...
                                                            <table cellpadding="0" cellspacing="0" class="es-left"
                                                                align="left"
                                                                style="mso-table-lspace: 0;mso-table-rspace: 0;border-collapse: collapse;border-spacing: 0;float: left;background-color: #fffcf0;border: 1px solid #0a8b4b;  border-radius: 12px; display: block;">
                                                                <tbody>
                                                                    <tr>
                                                                        <td class="es-m-p20b" align="left"
                                                                            style="padding: 0; margin: 0; width: 600px;">
                                                                            <h3 style="text-align:center; color: #0055da;">
                                                                                Order Details
                                                                            </h3>
                                                                            <hr>
                                                                            <table cellpadding="0" cellspacing="0"
                                                                                width="100%" bgcolor="#ffffff"
                                                                                style="mso-table-lspace: 0;mso-table-rspace: 0;border-collapse: separate;border-spacing: 0; border-radius: 15px;/* border: 1px solid #0a8b4b; */ background-color: transparent;"
                                                                                role="presentation">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td
                                                                                            style="padding:0  20px; margin: 0; line-height: 1.5rem;background-color: #fffcf0; color:#000;font-size:16px; border-radius: 12px;">
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td align="left"
                                                                                            ...
                                                                                            <p style="font-size:13px">⚡Our Loan Consultant will reach out to you within 24 to 48 hours and guide you towards your loan process!
                                                                                            <p>
                                                                                                Your Loan Consultation Person Details :
                                                                                            </p>
                                                                            ...
                                                                            <table cellpadding="0" cellspacing="0"
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td align="left"
                                                                                            style="padding: 20px; margin: 0; line-height: 1.5rem;background-color: #fffcf0; border-radius:12px;color:#000;font-size:16px">
                                                                                            <p style="font-size:13px">As per the details you provided, we’ve found the perfect loan offers! Please access your Loan Login links to quickly apply for the loan that suits you best:
                                                                                            <p>
                                                                                            ...
                                                                                            <a href="https://kreditsathi.com/customer/login"
                                                                                            ...
                                                                                            <p  style="font-size:13px">
                                                                                                🔗 Additionally, we’ve attached a 📄 PDF guide with helpful tips to improve your loan profile and boost your chances of approval.
                                                                                            </p>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                                        ...
                                                                                        <td align="center"
                                                                                            ...
                                                                                            <p style="
                                                                                                ...
                                                                                                <a target="_blank"
                                                                                                    ...
                                                                                                    href="https://kreditsathi.com/privacy-policy">
                                                                                                Privacy Policy
                                                                                                </a>
                                                                                                &nbsp; | &nbsp;
                                                                                                <a target="_blank"
                                                                                                    style="-webkit-text-size-adjust: none; -ms-text-size-adjust: none; mso-line-height-rule: exactly; text-decoration: none; color: #000f26; font-size: 14px;"
                                                                                                    href="https://kreditsathi.com/terms-and-conditions">
                                                                                                Terms &amp; Conditions
                                                                                                </a>
                                                                                                &nbsp; | &nbsp;
                                                                                                <a target="_blank"
                                                                                                    style="-webkit-text-size-adjust: none; -ms-text-size-adjust: none; mso-line-height-rule: exactly; text-decoration: none; color: #000f26; font-size: 14px;"
                                                                                                    href="https://kreditsathi.com/raise-request">
                                                                                                Raise a request
                                                                                                </a>
                                                                                                &nbsp; | &nbsp;
                                                                                                <a target="_blank"
                                                                                                ...
                                                                                                <tbody>
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td align="center"
                                                                                                            ...
                                                                                                            style="padding: 0; margin: 0; padding-right: 10px;">
                                                                                                            <a target="_blank"
                                                                                                                href="https://in.pinterest.com/kreditsathi/"
                                                                                                                style="
                                                                                                                -webkit-text-size-adjust: none;
                                                                                                                -ms-text-size-adjust: none;
                                                                                                                mso-line-height-rule: exactly;
